...
3. Deploy the CSI driver and wait until everything is up and running:
   ...
   ```
   kubectl apply -f https://raw.githubusercontent.com/hetznercloud/csi-driver/v1.2.1/deploy/kubernetes/hcloud-csi.yml
   ```
...
| ------------- | -----:| ------------------------------------------------------------------------------------------------------:|
| 1.16          | 1.2.1 | https://raw.githubusercontent.com/hetznercloud/csi-driver/v1.2.1/deploy/kubernetes/hcloud-csi.yml      |
